...
namespace InvSystem
{
    public partial class EndUser : System.Web.UI.Page
    {
        ...
        {
            string strQuery = "SELECT t0.[ID], t0.[NIK], t0.[Name], t1.[Name] [Region], t2.[Name] [Department], case when t0.[UsrStatus] = 'A' then 'Active' else 'Inactive' end[Status], t0.[Remarks] ";
